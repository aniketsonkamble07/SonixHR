...
@Getter
public class SubscriptionUpgradedEvent extends ApplicationEvent {
    ...
    public SubscriptionUpgradedEvent(TenantSubscription subscription, TenantSubscription previousSubscription,
