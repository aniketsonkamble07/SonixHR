...
public class PlatformTenantService {
        ...
        private final com.sonixhr.service.tenant.SubscriptionEventLogService subscriptionEventLogService;
        ...
        public PlatformTenantResponseDTO overrideTenantPlan(Long id, TenantPlanOverrideDTO dto) {
                ...
                // Update current active subscription settings - close old and create new with pro-rating
                ...
                if (oldSub != null) {
                        String oldSubStatus = oldSub.getStatus() != null ? oldSub.getStatus().name() : null;
                        oldSub.setIsActive(false);
                        if (oldSub.getBillingPeriodEnd() != null && oldSub.getBillingPeriodEnd().isAfter(now)) {
                        ...
                        oldSub.setStatus(PlanStatus.TERMINATED);
                        ...
                        subscriptionEventLogService.recordEvent(
                                        ...
                                        "Superseded by administrator plan override"
                        );
                }
                ...
                TenantSubscription sub = TenantSubscription.builder()
                                ...
                                .currency("INR")
                                .amount(plan.getPrice().subtract(proRatedCredit).max(java.math.BigDecimal.ZERO))
                                .build();
                subscriptionRepository.save(sub);
